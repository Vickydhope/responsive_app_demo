...
class SidebarDestination extends StatefulWidget {
  ...
  final List<SidebarDestinationData> data;
  final Function(int index, SidebarDestinationData value) onSelected;

  @override
  State<SidebarDestination> createState() => _SidebarDestinationState();
}

class _SidebarDestinationState extends State<SidebarDestination> {
  late int selected;
...
class _Button extends StatelessWidget {
  ...
  final bool selected;
  final SidebarDestinationData data;
  ...
  Widget _icon(IconData iconData) {
    return Icon(
      iconData,
      size: 20,
      color: (!selected) ? kFontColorPallets[1] : AppTheme.basic.primaryColor,
    );
  }
